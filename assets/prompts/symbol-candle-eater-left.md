# symbol-candle-eater-left

- Asset: `assets/sprites/symbol-candle-eater-left.png`
- Kind: map sprite
- Enemy: 蝋燭喰らい(ろうそくくらい)
- Direction: left(左向き)
...
- Adopted source: `/Users/goodapple/.codex/generated_images/019f49df-0b0c-7d73-b326-88c7f5c32e5c/exec-5f950dc7-a270-4339-88b8-fa3ce2944f17.png`
...
顔のない灰白い蝋だまりと琥珀の火を固定。厚い先行部と火を左、広い拖尾を右へ置いた低い俯瞰形。
...
Asset id: symbol-candle-eater-left.
...
Primary request: Render the exact same individual Candle Eater as Image 1 moving/facing LEFT. Generate independently.
...
Direction for this amorphous creature: the thick rounded leading wax rim and shallow flame depression are offset toward the canvas left; the wide puddle elongates left-to-right and several broad low wax lobes form a short dragged trail tapering toward the right. It must read as left at 34px.
...
Map readability: bold left-leading/right-trailing wide puddle silhouette; one amber flame dot; broad shapes only.
...
Avoid: directionless circle, tall wax tower, face-like holes, lantern, candlestick, clothing, skulls, runes, extra objects, eye-level view, pixel art.
```

## 後処理・検収メモ

- 正面bbox長辺160pxに合わせて透過・中央配置し、256x256 RGBAへ正規化。
- final alpha bbox: `(48, 82, 208, 173)`。四隅alpha: `[0, 0, 0, 0]`。
- 緑優勢の可視画素0。34px縮小で火が左、蝋の拖尾が右を確認。
