# sprite-caretaker-right

- Asset: `assets/sprites/sprite-caretaker-right.png`
- Kind: map sprite
- Character: 世話役 — イルマ
- Direction: right / 右プロフィール
- Created: 2026-07-10
- Generation mode: built-in Image Gen + `#00ff00` chroma-key removal
- Adopted source generation: `/Users/goodapple/.codex/generated_images/019f4aa7-5a5e-7702-bfdb-470f5bb6a38e/exec-55d25e4e-8938-4e82-bdf1-aed59d105487.png`
...
Asset type: correction pass for sprite-caretaker-right, a top-down overworld map sprite for the Japanese dark fantasy 2D RPG "The Dreaming Engine", final 256x256 transparent PNG displayed at about 32px.
Input images: Image 1 is the exact current RIGHT/EAST true profile edit target. Image 2 is Irma's canonical portrait identity. Image 3 is Irma's accepted compact steep-overhead DOWN/front sprite and is the required camera-height, foreshortening, body-scale, painterly density, palette, and padding anchor.
Primary request: Change only the camera steepness and compact map proportions of Image 1. Preserve the same RIGHT/EAST true profile, exact small thin elderly woman identity, grey-white hair carelessly gathered in a loose untidy bundle, heavily patched apron, worn layered clothing, narrow soot-stained fingers, boots, colors, lighting, and painterly style.
...
Direction invariant: Keep the facial profile, chest, knees, and toes unmistakably pointing right. Preserve the independently drawn loose hair bundle overlap, patched apron edge, soot-dark hand, and right-pointing boots.
...
Constraints: follow docs/spec/world-lore.md 3.6 exactly. Change only camera steepness and compact proportions. Do not mirror left and do not rotate toward the viewer, rear, or left. Do not make Irma stout, tall-looking, young, glamorous, richly dressed, neatly coiffed, eye-level, realistically proportioned, or give her props, jewelry, magic, extra characters, text, watermark, logo, frame, or UI.
```
...
- Source generation: `/Users/goodapple/.codex/generated_images/019f4aa7-5a5e-7702-bfdb-470f5bb6a38e/exec-ec32c171-e942-4421-ba8a-cfce4108f83c.png`
...
Input images: Image 1 is the exact canonical portrait identity, outfit, materials, and palette reference: assets/portraits/npc-caretaker.png. Image 2 is the exact accepted DOWN/front map sprite reference for this same character: preserve its compact proportions, scale, silhouette language, simplified painterly rendering, palette, and camera height while changing direction only. Image 3 is only an existing project reference for the accepted RIGHT/EAST orientation, steep overhead camera, square framing, and map-scale density. Do not copy Image 3's person, face, body, clothing, hair, or props.
Primary request: Create sprite-caretaker-right, Irma the caretaker facing RIGHT/EAST. Preserve the same small thin elderly woman; grey-white hair carelessly gathered in a loose untidy bundle; humble worn layered village clothing; heavily patched apron; narrow slender fingers darkened by hearth soot; practical dark footwear.
Orientation definition: RIGHT means a true right-facing profile. The facial profile, chest, knees, and toes point unmistakably toward the right edge. Do not face the viewer and do not use a 3/4 front pose. This must be a separately drawn orientation, never a mirrored copy of a left image.
Directional identity details: Show one clear elderly right facial profile beneath the large hair crown, narrow shoulder and torso, patched apron seen edge-on, one soot-dark slender hand, and right-pointing tiny boots. The loose hair bundle and garment overlap must be independently drawn for this right view, not mirrored from left.
...
- final alpha bbox: `(85, 21, 172, 231)`
- 四隅alpha: `[0, 0, 0, 0]`
- 鮮緑フリンジ検出: `0`、low-alpha緑優勢画素: `0`
- 32px検収: alpha>32の可視画素 `225`、縮小bbox `(8, 0, 24, 31)`。灰白髪束と右向きの顔・靴先、前掛けの大きな明暗塊が判別可能。左の鏡像ではなく個別生成。
- 視覚検収: 真上寄りの高俯瞰、頭頂・肩上面優位、足元小、接地影なし、文字なし、立ち絵との同一人物性を確認。
- right個別生成検証: leftを水平反転した画像とはピクセル一致せず、髪/腕/外套/前掛け/糸の重なりが独立。
