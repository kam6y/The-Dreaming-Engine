...
- Asset: `assets/sprites/sprite-warden-up.png`
- Kind: map sprite
- Character: 番人 — トワ
- Direction: up / 背面
- Created: 2026-07-10
- Generation mode: built-in Image Gen + `#00ff00` chroma-key removal
- Adopted source generation: `/Users/goodapple/.codex/generated_images/019f4aa7-5a5e-7702-bfdb-470f5bb6a38e/exec-76497503-9f5f-49a9-9779-5d5d1e9e5b5a.png`
...
Directional identity details: Show a true rear view with absolutely no face: the back/crown of the enormous hood, broad rear fall of the oversized adult cloak engulfing the small body, back cloak seam/folds, one hand with the wooden thread-spinning top and cord still distinguishable from behind, and tiny heels.
...
- final alpha bbox: `(69, 21, 188, 231)`
- 四隅alpha: `[0, 0, 0, 0]`
- 鮮緑フリンジ検出: `0`、low-alpha緑優勢画素: `0`
- 32px検収: alpha>32の可視画素 `290`、縮小bbox `(6, 0, 26, 31)`。顔を見せず、大外套背面と木製独楽・糸、 tiny heels が判別可能。
