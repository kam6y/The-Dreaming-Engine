...
- Asset: `assets/sprites/sprite-warden-right.png`
- Kind: map sprite
- Character: 番人 — トワ
- Direction: right / 右プロフィール
- Created: 2026-07-10
- Generation mode: built-in Image Gen + `#00ff00` chroma-key removal
- Adopted source generation: `/Users/goodapple/.codex/generated_images/019f4aa7-5a5e-7702-bfdb-470f5bb6a38e/exec-c133c821-bbe3-4736-ab63-e2b887c5973b.png`
...
Directional identity details: Show a true right profile: deep hood opening and only a tiny shadowed age-indeterminate right profile, the whole engulfing cloak mass and hem flow oriented right, hand and wooden thread-spinning top held in a clear side silhouette with its cord, and right-pointing tiny boots. Independently draw the right cloak folds, hand, cord drape, and top occlusion; do not mirror left and do not turn the top into a coin.
...
- 32px検収: alpha>32の可視画素 `221`、縮小bbox `(8, 0, 24, 31)`。右向きのフード開口・靴先、大外套、木製独楽と糸が判別可能。左の鏡像ではなく個別生成。
