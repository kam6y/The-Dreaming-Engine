# sprite-artisan-right

- Asset: `assets/sprites/sprite-artisan-right.png`
- Kind: map sprite
- Character: 職人 — ガロ
- Direction: right / 右プロフィール
- Created: 2026-07-10
- Generation mode: built-in Image Gen + `#00ff00` chroma-key removal
- Adopted source generation: `/Users/goodapple/.codex/generated_images/019f4aa7-5a5e-7702-bfdb-470f5bb6a38e/exec-2d2a69ab-9678-4c14-a470-753d51d2d4e6.png`
...
Directional identity details: Show a strong right-facing profile: shaved scarred crown, brow/nose/chest/knees/toes all point right, enormous shoulder and torso compressed from above, leather apron in side profile, one large amber-stained hand, thick compact legs and right-pointing tiny boots. Independently draw the scar, arms, apron folds and occlusion for the right view; do not mirror left.
...
- final alpha bbox: `(80, 21, 176, 231)`
- 四隅alpha: `[0, 0, 0, 0]`
- 鮮緑フリンジ検出: `0`、low-alpha緑優勢画素: `0`
- 32px検収: alpha>32の可視画素 `253`、縮小bbox `(7, 0, 25, 31)`。右向きの頭部・鼻先・靴先、巨体、革前掛け、飴色の手が判別可能。左の鏡像ではなく個別生成。
